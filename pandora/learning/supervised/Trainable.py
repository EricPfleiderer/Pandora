...
class TorchTrainable:
    ...
    def __init__(self, params):
        ...
        # Torch data loaders
        self.train_loader, self.test_loader = get_loaders(params['dataset'], params['batch_size'])
    ...
    def train(self):
        ...
        logging.info(f'Training the image classifier for ' + str(self.params['num_epochs']) + ' epochs.')
